...
The harness records worker and runtime backpressure observations, total completion counts per owner, GC completions/cycles, maximum observed PHP memory, elapsed time, and whether PHP GC completions were observed while native work was still outstanding. This records behavior without inventing a production throughput threshold.
